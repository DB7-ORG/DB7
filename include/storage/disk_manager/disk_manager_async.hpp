...
#define MAX_PATH_LEN 256u
    ...
    public:
        ...
        bool SubmitRead(page_id pid, void *buf, u32 len, off_t offset, void *user_data);
        bool SubmitWrite(page_id pid, const void *buf, u32 len, off_t offset, void *user_data);
