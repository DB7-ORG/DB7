...
struct HashUtil {
  ...
  /* 64-bit variant */
  static inline u64 murmurhash64(u64 data) {
    u64 h = data;
   ...
   * either an integral number (8- to 64-bits) or floating point number.
   ...
   */
  // static hash_t ScrambleHash(const hash_t hash) { return
