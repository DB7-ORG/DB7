...
/**
 * DerivedValueExpression represents a tuple of values that are derived from
 * nested expressions
 *
...
public:
   ...
   * TODO(WAN): does it make sense to make this a private constructor, and
   * friend the optimizer? Ask William, Ling.
