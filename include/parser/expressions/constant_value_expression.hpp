...
#include "excecution/sql/value.hpp"
...
namespace noisepage::parser
{
    ...
    public:
        ...
        {
            assert(std::holds_alternative<execution::sql::BoolVal>(value_) && "Invalid variant type for Get.");
        ...
        {
            assert(std::holds_alternative<execution::sql::Integer>(value_) && "Invalid variant type for Get.");
        ...
        {
            assert(std::holds_alternative<execution::sql::Real>(value_) && "Invalid variant type for Get.");
        ...
        {
            assert(std::holds_alternative<execution::sql::DecimalVal>(value_) && "Invalid variant type for Get.");
        ...
        {
            assert(std::holds_alternative<execution::sql::DateVal>(value_) && "Invalid variant type for Get.");
        ...
        {
            assert(std::holds_alternative<execution::sql::TimestampVal>(value_) && "Invalid variant type for Get.");
        ...
        {
            assert(std::holds_alternative<execution::sql::StringVal>(value_) && "Invalid variant type for Get.");
