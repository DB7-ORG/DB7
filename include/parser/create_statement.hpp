...
namespace noisepage::parser
{
    ...
    struct ColumnDefinition
    {
        ...
        static execution::sql::SqlTypeId StrToValueType(
            char *str)
        { // TODO(Matt): compare with execution::sql::SqlTypeIdFromString to check redundancy
        ...
        hash_t Hash() const
        {
            ...
            if (check_expr_ != nullptr)
                hash = common::HashUtil::CombineHashes(hash, check_expr_->Hash());
        ...
        bool operator==(const ColumnDefinition &rhs) const
        {
            ...
            if (type_modifier_ != rhs.type_modifier_)
                return false;
            if ((!default_expr_ && rhs.default_expr_) || (default_expr_ && default_expr_ != rhs.default_expr_))
                return false;
    ...
    public:
        ...
        {
            assert(expr_ == nullptr && "Expressions don't come with names.");
            return name_;
        }
