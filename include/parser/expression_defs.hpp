...
#include "common.hpp"
#include "shared/enum_defs.hpp"

#include <stdexcept> // IWYU pragma: keep
#include <string>

namespace db7::parser {
using alias_oid_t = std::size_t;
...
/** @return A short representation of @p type, e.g., "+" over "OPERATOR_PLUS".
 * Used for expression name generation. */
