...
VISITOR_ESTIMATE_SRC := src/storage/compression_framework/visitors/estimate_sampling_visitor.cpp
...
VISITOR_ESTIMATE_OBJ := $(OBJ_DIR)/storage/compression_framework/visitors/estimate_sampling_visitor.o
