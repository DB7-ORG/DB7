...
#define ENUM_FROM_STRING(EnumType, EnumVal)     \
    ...
    { /* NOLINT readability/braces confusion */ \
...
#define ENUM_DEFINE(EnumName, EnumCppType, EnumValMacro)                                             \
    ...
    inline std::string EnumName##ToString(EnumName type)                                             \
    { /* NOLINT inline usage */                                                                      \
        switch (type)                                                                                \
        {                                                                                            \
    ...
    { /* NOLINT inline usage */                                                                      \
        if (false)                                                                                   \
        { /* This check starts an if-else chain for the macro. */                                    \
        }                                                                                            \
        EnumValMacro(ENUM_FROM_STRING) else                                                          \
        { /* NOLINT readability/braces confusion */                                                  \
